# Prompt #4：AI 3D 房车（拖挂式旅居车）模型生成 Prompt 集
...
CARAVAN_POSITIONS = {
    # 皮卡 (overall_length=5.3m, front_overhang=0.9m)
    'pickup': {
        'S': -5.6,   # 紧凑型房车前壁
        'M': -5.6,
        'L': -5.9,   # 大型房车牵引杆略长
    },
    # SUV (overall_length=4.6m, front_overhang=0.9m)
    'suv': {
        'S': -4.9,
        'M': -4.9,
        'L': -5.2,
    },
    # 旅行车 (overall_length=4.8m, front_overhang=0.85m)
    'wagon': {
        'S': -5.15,
        'M': -5.15,
        'L': -5.45,
    },
    # A级小车 (overall_length=4.0m, front_overhang=0.8m)
    'hatchback': {
        'S': -4.4,
        'M': -4.4,
        'L': -4.7,
...
|------|:---:|:---:|:---:|:---:|
| 任意车型 + 紧凑型 S | 1.75~1.85 | 2.08 | 0.12~0.17 | 轻微 |
| 任意车型 + 中型 M | 1.75~1.85 | 2.30 | 0.23~0.28 | 中等 |
| 任意车型 + 大型 L | 1.75~1.85 | 2.50 | 0.33~0.38 | 严重 |
| **A级小车 + 大型 L** | **1.75** | **2.50** | **0.38** | **最严重** |
